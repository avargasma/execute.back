/****** Object:  StoredProcedure [MC].[Conversation_s_Comments]    Script Date: 20/11/2019 16:31:03 ******/
SET ANSI_NULLS ON
GO
...
BEGIN  
 ...
 -- left(cc.[CaseCommentText],5000) as CaseCommentText, 
  ...
  cc.SCName, cc.PublicationDate, cc.SCInternalCode, cc.ProcessDetailsId,   
  cc.DCCPermlinkRoot,cc.DCCOnline,  
  ...
  sc.SCName, p.PublicationDate, sc.SCInternalCode, cc.ProcessDetailsId,   
  ...
  e.ReplyToComments,cc.ReplyToCaseCommentId,cc1.CaseCommentId as AnsweredByCommentId 
  FROM #tb cc  
  ...
  LEFT JOIN mc.Publication p ON p.CaseCommentGUID = cc.CaseCommentGUID ) cc  
 ...
 BEGIN    
  ...
  ,cc.[ElementTypeId], e.PChannelType, cc.[ElementId],
  e.ElementTypePublic, e.ElementTypeOutput, e.ServiceChannelId,dcc.[DCCSubject],  
  sc.SCName, p.PublicationDate, sc.SCInternalCode, cc.ProcessDetailsId, dcc.DCCPermlinkRoot,  
